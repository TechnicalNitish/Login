...
<form action="registrationservlet" method="post" style="margin:350px;margin-top:120px;border:2px solid red;border-radius:4px;padding:20px;background-color:cyan;padding:120px" >
	...
	User name:  <input type="text" name="username" style="margin-bottom:3px;color:cyan;margin-left:20px"><br>
	Password:	<input type="password" name="password" style="margin-bottom:3px;color:cyan;margin-left:20px"><br>
	Mobile :	<input type="text" name="mobile" style="margin-bottom:3px;color:cyan;margin-left:20px"><br>
